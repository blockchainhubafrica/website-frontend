...
export default function BlogPage() {
  ...
  return (
    <main className={`${styles["container"]} py-10 md:py-20 px-5 md:px-10 lg:px-20`}>
      <div className="md:w-3/4 lg:w-1/2 mb-10 md:mx-10 lg:mx-20">
        <h3 className={`spaced-heading text-base mb-5 font-coolvetica`}>BLOG</h3>
        <h3 className={`mb-4 pt-3 pb-5 md:pb-10 text-4xl md:text-7xl font-coolvetica text-blue-600`}>
      ...
      >
        <div className="flex flex-col col-span-2">
          ...
          <h3 className="text-3xl md:text-5xl my-5 md:my-10"><Link href="#">How we can 2nd-Runner up at Xend Finance Hackathon, 2021</Link></h3>
          <span className="">Dec 18, 2021. <strong>12 min Read</strong></span>
        </div>
      ...
      <section className={`${styles["articles-container"]} pt-5`} ref={containerRef}>
        ...
        {articles.length > 6 ? (
          <div className={`${styles["button-container"]} mt-8 md-mt-14`}>
            {currentSlide[0] !== 0 ? (
              <button id="article-slider-btn-1" className="mr-8" onClick={goLeft}>
